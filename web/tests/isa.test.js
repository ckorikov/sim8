...
describe("Reg", () => {
    ...
    it("ARITH_CODES = {0,1,2,3,4}", () => {
        expect(ARITH_CODES).toEqual(new Set([0, 1, 2, 3, 4]));
    });

    it("STACK_CODES = {0,1,2,3,5}", () => {
        expect(STACK_CODES).toEqual(new Set([0, 1, 2, 3, 5]));
    });
});
...
describe("OpType", () => {
    it("has all expected types", () => {
        ...
        expect(OpType.REG_ARITH).toBe("reg_arith");
